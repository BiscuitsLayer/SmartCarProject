...
public:
    ...
    void LoadGeometry(GL::Program &program) {
        ...
        cbo_ = GL::VertexBuffer(colors.data(), colors.size() * APP_VEC3_BYTESIZE, GL::BufferUsage::StaticDraw);
    ...
    void Draw(GL::Context &gl, GL::Program &program) {
        gl.DrawElements(vao_, GL::Primitive::Triangles, 0, indices.size(), GL::Type::UnsignedInt);
    }
